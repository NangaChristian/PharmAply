  ...
  return (
    <div className="flex-1 bg-slate-50 flex flex-col h-full overflow-hidden">
      <div className="bg-white dark:bg-zinc-950 px-8 pt-6 pb-6 shadow-sm z-10 border-b border-gray-200 shrink-0">
         <h1 className="font-bold text-gray-900 dark:text-white text-2xl mb-1"> {t('profile_settings', 'Profile Settings')} </h1>
      ...
      <div className="flex-1 overflow-y-auto p-8 max-w-4xl space-y-6">
         <div className="bg-white dark:bg-zinc-950 rounded-2xl p-6 shadow-sm border border-slate-100 flex gap-6 items-start">
            ...
            <div>
               <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-1">{user?.displayName || "Platform Admin"}</h2>
         ...
         <div className="bg-white dark:bg-zinc-950 rounded-2xl p-6 shadow-sm border border-slate-100">
            ...
            <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 flex items-center justify-between">
               <div>
                  <p className="font-bold text-slate-800 dark:text-slate-100 text-sm"> {t('update_password', 'Update Password')} </p>
               ...
               <button className="px-4 py-2 bg-white dark:bg-zinc-950 border border-slate-200 rounded-xl text-sm font-bold text-slate-700 shadow-sm hover:bg-slate-50">
