  ...
  return (
    <div className="flex-1 bg-slate-50 flex flex-col h-full overflow-hidden">
      <div className="bg-white px-8 pt-6 pb-6 shadow-sm z-10 border-b border-gray-200 shrink-0 flex items-center justify-between">
         <div>
             <h1 className="font-bold text-gray-900 text-2xl mb-1">Reports & Analytics</h1>
             <p className="text-gray-500 text-sm">Monitor platform metrics and extract data</p>
         </div>
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
             ...
             <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 relative overflow-hidden">
                ...
                <p className="text-sm font-bold text-slate-500 mb-1">Pharmacies</p>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 h-96">
             <h3 className="text-lg font-bold text-slate-900 mb-6">Weekly Revenue Overview</h3>
