    ...
    <div className="flex-1 bg-slate-50 flex flex-col h-full overflow-hidden">
      <div className="bg-white px-8 pt-6 pb-6 shadow-sm z-10 border-b border-gray-200 shrink-0 flex items-center justify-between">
         <div>
             ...
             <h1 className="font-bold text-gray-900 text-2xl mb-1">Delivery Zones & Maps</h1>
             <p className="text-gray-500 text-sm">Manage service regions and surge pricing</p>
         </div>
         <button 
           onClick={handleSave} 
           disabled={loading}
      ...
      <div className="flex-1 overflow-y-auto p-8 max-w-3xl space-y-6">
         <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-4">
               ...
               <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Surge Pricing Multiplier</label>
                  <input 
                    type="number" 
                    step="0.1"
