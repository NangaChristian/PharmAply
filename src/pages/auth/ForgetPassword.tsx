    ...
    <div className="flex-1 bg-slate-50 flex flex-col h-full scrollbar-hide">
      ...
      <div className="p-6 flex-1 flex flex-col items-center pt-8">
         <div className="w-full max-w-sm">
            <h1 className="text-2xl font-bold text-slate-800 text-center mb-2">Forget Your Password</h1>
            ...
            {!isSent ? (
               ...
               <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-sm text-slate-500">
                     Didn't get the email? <button onClick={handleReset} className="text-indigo-600 font-bold hover:underline">Resend it.</button>
                  </p>
               </div>
            )}
         </div>
