  ...
  return (
    <div className="flex-1 bg-slate-50 dark:bg-black flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col items-center justify-center text-center pb-24">
         ...
         <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 mb-8 max-w-xs">{t('cart_empty_desc', 'Looks like you haven\'t added anything to your cart yet. Explore our wide range of products.')}</p>
