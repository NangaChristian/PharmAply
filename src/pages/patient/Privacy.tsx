  ...
  return (
    <div className="flex-1 bg-slate-50 dark:bg-black flex flex-col h-full overflow-hidden">
      <div className="bg-white dark:bg-black px-6 pt-12 pb-4 shadow-sm z-10 flex items-center gap-4">
         ...
         <h1 className="font-bold text-gray-900 dark:text-white text-xl">{t('privacy_security', 'Privacy & Security')}</h1>
      </div>

      <div className="flex-1 overflow-y-auto p-6 space-y-6">
         <div className="bg-white dark:bg-black rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-zinc-800">
            ...
            <div className="space-y-4">
               <div className="flex items-center justify-between border-b border-gray-50 pb-4">
                  <div>
                     <h3 className="font-bold text-sm text-gray-900 dark:text-white">{t('change_password', 'Change Password')}</h3>
                     <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">{t('change_password_desc', 'Update your account password')}</p>
                  </div>
               ...
               <div className="flex items-center justify-between border-b border-gray-50 pb-4">
                  <div>
                     <h3 className="font-bold text-sm text-gray-900 dark:text-white">{t('two_factor', 'Two-Factor Authentication')}</h3>
                     <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-1">{t('two_factor_desc', 'Add an extra layer of security')}</p>
                  </div>
                  <div className="w-10 h-6 bg-gray-200 rounded-full relative cursor-pointer">
                     <div className="w-4 h-4 bg-white dark:bg-black rounded-full absolute left-1 top-1 shadow-sm"></div>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div className="bg-white dark:bg-black rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-zinc-800">
            <h2 className="font-bold text-gray-900 dark:text-white mb-4">{t('privacy_policy', 'Privacy Policy')}</h2>
